...
public class JPRestletModule implements JPublishModule {
  ...
  private List<String> restJPublishURLS = new ArrayList<String>();
  ...
  public static final String JPRESTLET_RESPONSE_STATUS = "jprestlet_response_status";
  public static final String JPRESTLET_RESPONSE_LOCATION_REF = "jprestlet_response_location_ref";
